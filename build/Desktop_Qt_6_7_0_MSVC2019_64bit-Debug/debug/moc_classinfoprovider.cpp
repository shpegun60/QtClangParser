...
Q_CONSTINIT static const uint qt_meta_data_CLASSClassInfoProviderENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       6,    0,   42,    4, 0x102,    4 /* Public | MethodIsConst  */,
       7,    1,   43,    4, 0x102,    5 /* Public | MethodIsConst  */,
...
void ClassInfoProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { QStringList _r = _t->classes();
            if (_a[0]) *reinterpret_cast< QStringList*>(_a[0]) = std::move(_r); }  break;
        case 3: { QStringList _r = _t->getClassMembers((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QStringList*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
